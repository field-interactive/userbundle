...
class ResettingController extends Controller
{
    ...
    {
        $form = $this->createForm('UserBundle\Form\UserEmailType');
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        $user = $em->getRepository('UserBundle:User')->findOneBy(array('email' => $confirmation[0]));
        ...
        $form = $this->createForm('UserBundle\Form\ResetPasswordType', $user);
